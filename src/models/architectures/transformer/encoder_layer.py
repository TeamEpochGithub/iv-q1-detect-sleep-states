...
class EncoderLayer(nn.Module):
    ...
    def __init__(self, heads: int = 6, emb_dim: int = 92, expansion: int = 4, dropout: float = 0.1, attention: dict = {"type": "normal"}) -> None:
        super().__init__()
    ...
    def forward(self, x: torch.Tensor, src_mask: torch.Tensor = None, is_causal: bool = False, src_key_padding_mask: torch.Tensor = None) -> torch.Tensor:
        """
