...
def get_pretrain_full_cache(config_loader: ConfigLoader, featured_data: pd.DataFrame, save_output: bool = True) \
    ...
    """
    pretrain_config_hash: str = hash_config(config_loader.get_pretrain_config())
    path: str = config_loader.get_pp_out() + '/pretrain_full' + pretrain_config_hash + '.pkl'
