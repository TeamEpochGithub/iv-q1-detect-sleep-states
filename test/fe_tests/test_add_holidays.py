...
class Test(TestCase):
    ...
    def test_add_holidays(self) -> None:
        data_before: dict = {0: pd.DataFrame({
            'timestamp': pd.date_range('2017-6-28', '2017-10-9', tz='UTC')
        })}
    ...
    def test_add_holidays_middle_school(self) -> None:
        data_before: dict = {0: pd.DataFrame({
            'timestamp': pd.date_range('2018-6-11', '2018-6-12', tz='UTC')
        })}
    ...
    def test_add_holidays_high_school(self) -> None:
        data_before: dict = {0: pd.DataFrame({
            'timestamp': pd.date_range('2018-1-26', '2018-1-27', tz='UTC')
        })}
