...
class TestOptimizer(TestCase):
    ...
    def test_get_optimizer_adam(self):
        ...
        optimizer = Optimizer.get_optimizer(optimizer_text, self.lr, self.weight_decay, self.model)
    ...
    def test_get_optimizer_error(self):
        ...
        with self.assertRaises(Exception) as context:
            Optimizer.get_optimizer(optimizer_text, self.lr, self.weight_decay, self.model)
